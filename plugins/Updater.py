...
from modules.config import SUDO_USERS as SUDO_USER
...
async def update(client: Client, message: Message):
    ...
    REPO_ = environ.get(
    "UPSTREAM_REPO", "https://github.com/ShailendraOP/HeroMusic"
    )
    ...
    try:
        ...
        return await msg_.edit(
            "`Invalid Git Command. Please Report This Bug`"
        )
    ...
    if not HEROKU_URL:
        ...
        await runcmd("pip3 install -U -r Installer")
